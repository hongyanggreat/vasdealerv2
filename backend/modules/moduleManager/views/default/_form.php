      ...
      <div class="span7 offset2">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <?= $form->field($model, 'RESOURCE', ['template' => '{label} <div class="controls">{input}{error}{hint}</div>','options' => ['class' => 'control-group']])->textInput(['class'=>'span11','placeholder'=>'Điền tên module','disabled'=>$disabled]) ?>
            <?= $form->field($model, 'NAME', ['template' => '{label} <div class="controls">{input}{error}{hint}</div>','options' => ['class' => 'control-group']])->textInput(['class'=>'span11','placeholder'=>'Tên module']) ?>
            ...
            <?php 
             ...
             ?>
            <?= $form->field($model, 'TYPE',['template' => '{label} <div class="controls">{input}{error}{hint}</div>','options' => ['class' => 'control-group']])->radioList($userType)?>
