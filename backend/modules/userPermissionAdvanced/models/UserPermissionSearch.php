...
/**
 * UserPermissionSearch represents the model behind the search form about `backend\modules\userPermissionAdvanced\models\UserPermission`.
 */
class UserPermissionSearch extends UserPermission
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ID', 'ACC_ID', 'MODULE_ID', 'CREATE_DATE', 'CREATE_BY', 'UPDATE_DATE', 'UPDATE_BY', 'STATUS'], 'integer'],
