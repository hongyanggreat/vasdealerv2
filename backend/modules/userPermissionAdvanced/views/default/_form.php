  ...
  <div class="row-fluid">
      ...
      <div class="widget-box">
          <div class="widget-title"><span class="icon"> <i class="icon-ok-sign"></i> </span>
            <h5>Danh sách quyền tài khoản : <?= $dataUser->USERNAME ?></h5>
...
<td style="width:80px;text-align: center;"><span> <input type="checkbox" <?php echo $statusUserPermission ?> class="checkboxpermission" name="status<?= $idModule  ?>" /></span></td>
